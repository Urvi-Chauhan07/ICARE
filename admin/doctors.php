...
?>
                ...
                <tr >
                    <td colspan="2" style="padding-top:30px;max-width: 220px;display: block;width: 100%;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">Add New Doctor</p>
                    </td>
                    <td colspan="2">
                        <a href="?action=add&id=none&error=0" class="non-style-link"><button  class="login-btn btn-primary btn button-icon"  style="display: flex;justify-content: center;align-items: center;margin-left:75px;background-image: url('../img/icons/add.svg');margin-top:35px">Add New</font></button>
                            </a></td>
                </tr>
                <tr>
